        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                    <img src="/img/logo-pplg.png" class="h-8 me-3" alt="FlowBite Logo" />
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">PPLG</span>
                </a>
            </div>
        ...
        <ul class="space-y-2 font-medium">
            ...
            @if (auth()->user()->role === 'admin')
                <li>
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Latar Belakang</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Visi Misi</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('forces') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Angkatan</span>
                    </a>
                </li>
            @endif
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Kembali ke Web</span>
                </a>
            </li>
        </ul>
    </div>
