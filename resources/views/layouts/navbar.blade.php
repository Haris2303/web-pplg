<nav class="w-full bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 fixed z-[5] shadow-md top-0">
            ...
            <ul
                ...
                <li>
                    ...
                    <div id="dropdownNavbar"
                        ...
                        <div class="py-1">
                            <a href="/about-app"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Informasi
                                Aplikasi</a>
                        </div>
                    </div>
                </li>
